...
7a) Run setup.sh and then copy the war file to tomcat's webapps directory.
...
-----------------------------------------------------
Change the poll interval to suit your needs.  The time is in milliseconds.  It specifies the interval between instances of polling the web service for new faxes and sending pending faxes.
